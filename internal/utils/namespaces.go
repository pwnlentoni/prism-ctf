...
// +kubebuilder:rbac:groups=*,resources=namespaces;httproutes;tlsroutes;deployments;services;ciliumnetworkpolicies;configmaps,verbs=get;list;watch;create;update;patch;delete

func SharedChallengeNamespace(challenge string) string {
	return SharedChallengesNamespacePrefix + challenge
}

func IsolatedChallengeNamespace(challenge string, team string, rid string) string {
	b := strings.Builder{}
